    ...
    <?php
        ...
        <div class="col-4">
            <div class="card" style="width: 20rem; margin-top: 1%; ">
                <a href="#" onclick="bootbox.confirm('Deseas realizar esta accion', function(result){if(result == true){location.href='eliminar_imagen.php?clave_producto=<?php echo $clave; ?>&clave_img=<?php echo $f_img['clave']; ?>&ruta=<?php echo $f_img['ruta']; ?>'}})"><img src="<?php echo $f_img['ruta']; ?>" class="card-img-top" alt=""></a>
            </div>
        </div>
