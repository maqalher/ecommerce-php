...
<div class="card text-white bg-dark" style="margin-top: 1%;">
        <div class="card-header">
            <h4 class="card-title">Inventario <?php echo $opc; ?></h4>
        </div>
        <div class="card-body">
            <table class="table">
                <thead>
                    ...
                    <?php
                        ...
                        if($opc == 'GENERAL'){
                            ...
                            while($f = $sel->fetch()){ ?>
                                ...
                                <tr>
                                    <td><img src="<?php echo $f['foto']; ?>" width="50" heigth="50" alt=""></td>
                                    ...
                                    <td><a href="#" class="btn btn-outline-danger btn-sm" onclick="bootbox.confirm('Seguro que desea realizar esta accion', function(result){ if (result == true){ location.href='eliminar_producto.php?clave=<?php echo $f['clave'] ?>&foto=<?php echo $f['foto'] ?>&pag=categorias.php&opc=<?php echo $opc; ?>';} })"><span class="material-icons" >clear</span></a></td>
                               </tr>
                            <?php
                            }
                            $sel = null;
